; This is based on ../origin/lc3os.asm, which is originally from https://acg.cis.upenn.edu/milom/cse240-Fall05/handouts/code/lc3os.asm
...
OS_START
	LEA R0,STARTING_MSG	; prompt for input
	PUTS
...
BOOT_SAVED_PSR	.FILL x8000	; saved PSR for boot code, with Privilege bit set (user mode), Priority level = 0 and nzp = 000
